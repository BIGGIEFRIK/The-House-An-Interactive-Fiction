...
let blacklightaction = /blacklight/;
let blacklight = function(action, player, object) {
  if (action == 'blacklight') {
    let text = "";
    addLine("All over the room, the phrase, 'demons are coming' is written in ink only seeable under blacklight.");
  }
  return player
}
addAction(blacklightaction, blacklight);
